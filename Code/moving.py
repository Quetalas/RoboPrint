...
class Tower:
    ...
    def __init__(self, car_x=-290, car_y=290, car_z=290, car_e=-290, step_length=10, std_v =40, std_v_ext=0.1):
        ...
        x, y, z = self.pos_from_cars(car_x, car_y, car_z, car_e)
        self.x = x
        self.y = y
        self.z = z
        self.step_length = step_length
        self.vel = std_v    # если не дано в команде, то бер1тся предыдущая
